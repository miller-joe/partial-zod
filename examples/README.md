...
Run any of them with `npx tsx examples/<file>.ts`. The `simulated.ts` demo is also wired to `npm run demo` (compiles with tsc, runs plain Node — works on Node 18 and in Stackblitz).
